...
/**
 * Implements TagMatchIO for TagMatchFrame
 */
public class TagMatchIO {
    private TagMatchManager tagMatchManager;
    private String selfID;
    private TagDataAccess tagManager;

    /**
     * Constructs TagMatchIO
     * @param self a user
     ...
     */
    public TagMatchIO(String userID, CourseDataAccess courseDataAccess, UserDataAccess userDataAccess, TagDataAccess tagDataAccess){
        this.selfID = userID;
