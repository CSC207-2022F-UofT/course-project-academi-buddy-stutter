...
/**
 * Implements ProfileDisplayIO for ProfileDisplayFrame
 */
public class ProfileDisplayIO {

    private String userID;
    private ProfileManager profileManager;

    /**
     * Constructs ProfileDisplayIO
     * @param courseDataAccess an instance of CourseDataManager
     * @param userDataAccess an instance of UserDataManager
     */
    public ProfileDisplayIO(String userID, CourseDataAccess courseDataAccess, UserDataAccess userDataAccess, TagDataAccess tagDataAccess){
        this.userID = userID;
