...
/**
 * Implements FriendListIO for FriendListFrame
 */
public class FriendListIO {
    private FriendListManager friendListManager;
    private String self;
    public FriendListIO(String userID, CourseDataAccess courseDataAccess, UserDataAccess userDataAccess, TagDataAccess tagDataAccess) {
