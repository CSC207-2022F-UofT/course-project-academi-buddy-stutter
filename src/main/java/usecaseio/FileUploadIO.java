...
/**
 * Implements FileUploadIO for FileUploadFrame
 */
public class FileUploadIO {
    private UploadManager uploadManager;
    private String selfID;

    /**
     * Constructs FileUploadIO
     * @param self a user
     * @param courseDatabase an instance of CourseDataManager
     * @param userDatabase an instance of UserDataManager
     */
    public FileUploadIO(String userID, CourseDataAccess courseDataAccess, UserDataAccess userDataAccess, TagDataAccess tagDataAccess){
        this.selfID = userID;
