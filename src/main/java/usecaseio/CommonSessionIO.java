...
/**
 * Implements CommonSessionIO for CommonSessionFrame
 */
public class CommonSessionIO {
    private CommonSessionManager commonSessionManager;
    private String selfID;

    /**
     * Constructs CommonSessionIO
     ...
     */
    public CommonSessionIO(String userID, CourseDataAccess courseDataAccess, UserDataAccess userDataAccess, TagDataAccess tagDataAccess){
        this.selfID = userID;
