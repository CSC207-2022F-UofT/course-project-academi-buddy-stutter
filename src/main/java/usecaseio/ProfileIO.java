...
/**
 * Implements ProfileIO for ProfileFrame
 */
public class ProfileIO {
    ...
    /**
     * Constructs ProfileIO
     * @param user a user
     * @param courseDataAccess an instance of CourseDataManager
     * @param userDataAccess an instance of UserDataManager
     */
    public ProfileIO(String userID, CourseDataAccess courseDataAccess, UserDataAccess userDataAccess, TagDataAccess tagDataAccess){
        this.selfID = userID;
