...
/**
 * Implements RegisterIO for RegisterFrame
 */
public class RegisterIO {
    private RegisterManager registerManager;

    /**
     * Constructs RegisterIO
     * @param courseDatabase an instance of CourseDataManager
     * @param userDatabase an instance of UserDataManager
     */
    public RegisterIO(String userID, CourseDataAccess courseDataAccess, UserDataAccess userDataAccess, TagDataAccess tagDataAccess) {
