...
/**
 * Implements LoginIO for LoginFrame
 */
public class LoginIO {
     ...
     */
    public LoginIO(String userID, CourseDataAccess courseDataAccess, UserDataAccess userDataAccess, TagDataAccess tagDataAccess){
